...
\begin{figure}[h!]
    ...
    \end{axis}
    \end{tikzpicture}
    \caption{Regulator DMC z pomiarem zak³óceñ: $f = 6,2832, K = 1, E = 8,9114$}
\end{figure}
\begin{figure}[h!]
    \centering
    \begin{tikzpicture}
    ...
    \end{axis}
    \end{tikzpicture}
    \caption{Regulator DMC z pomiarem zak³óceñ: $f = 31,4159, K = 0,1, E = 10,1471$}
\end{figure}
\begin{figure}[h!]
    \centering
    \begin{tikzpicture}
    \begin{axis}[
    width=0.7\textwidth,
    xmin=0.0,xmax=100,ymin=0,ymax=2.6,
    xlabel={$k$},
    ylabel={$y[k], \ u[k], z[k]$},
    legend pos=south east,
    y tick label style={/pgf/number format/1000 sep=},
...
\begin{figure}[h!]
    ...
    \end{axis}
    \end{tikzpicture}
    \caption{Regulator DMC bez pomiaru zak³óceñ: $f = 6,2832, K = 1, E = 42,4819$}
\end{figure}
\begin{figure}[h!]
    \centering
    \begin{tikzpicture}
    ...
    \end{axis}
    \end{tikzpicture}
    \caption{Regulator DMC bez pomiaru zak³óceñ: $f = 31,4159, K = 0,1, E = 10.9901$}
\end{figure}
\begin{figure}[h!]
    \centering
    \begin{tikzpicture}
    ...
    \end{axis}
    \end{tikzpicture}
    \caption{Regulator DMC bez pomiaru zak³óceñ: $f = 31,4159, K = 1, E = 69,1634$}
\end{figure}
